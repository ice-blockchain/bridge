...
### 5.5 Mobile → ION: Detect Mint Completion
...
## 6. Direction D: ION → Old ICE on BSC
...
### 6.3 Sending a Bridge Transaction on ION
...
### 6.5 Mobile → BSC: Detect Mint Completion
